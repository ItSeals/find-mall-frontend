...
import MallCreate from './mallsComponets/MallCreate';
import MallEdit from './mallsComponets/MallEdit';
import MallItem from './mallsComponets/MallItem';

const MallsTable = (props) => {
  ...
  if (createPage) {
    return (
      <Link to='/create' className={`${props.className} position-fixed`} AM={AddMall} prePage={setCreatePage}>fdfddff</Link>
    )
  } else if (editPage.is) {
    return (
